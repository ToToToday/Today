...
namespace Today.Web.Migrations
{
    ...
    [Migration("20220702145728_Initdb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Today.Web.Models.AboutProgram", b =>
                {
            ...
            modelBuilder.Entity("Today.Web.Models.AboutProgramOption", b =>
                {
                    b.Property<int>("AboutProgramOptionsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Today.Web.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("Today.Web.Models.City", b =>
                {
            ...
            modelBuilder.Entity("Today.Web.Models.CityRaider", b =>
                {
            ...
            modelBuilder.Entity("Today.Web.Models.Collect", b =>
                {
            ...
            modelBuilder.Entity("Today.Web.Models.Comment", b =>
                {
            ...
            modelBuilder.Entity("Today.Web.Models.Coupon", b =>
                {
            ...
            modelBuilder.Entity("Today.Web.Models.CouponManage", b =>
                {
            ...
            modelBuilder.Entity("Today.Web.Models.Location", b =>
                {
            ...
            modelBuilder.Entity("Today.Web.Models.LoginWay", b =>
                {
            ...
            modelBuilder.Entity("Today.Web.Models.Member", b =>
                {
                    b.Property<int>("MemberId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Today.Web.Models.Message", b =>
                {
            ...
            modelBuilder.Entity("Today.Web.Models.Order", b =>
                {
                    b.Property<int>("OrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Today.Web.Models.OrderDetail", b =>
                {
                    b.Property<int>("OrderDetailsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Today.Web.Models.Payment", b =>
                {
                    b.Property<int>("PaymentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Today.Web.Models.Product", b =>
                {
                    b.Property<int>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Today.Web.Models.ProductCategory", b =>
                {
            ...
            modelBuilder.Entity("Today.Web.Models.ProductPhoto", b =>
                {
            ...
            modelBuilder.Entity("Today.Web.Models.ProductTag", b =>
                {
            ...
            modelBuilder.Entity("Today.Web.Models.Program", b =>
                {
                    b.Property<int>("ProgramId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Today.Web.Models.ProgramCantUseDate", b =>
                {
            ...
            modelBuilder.Entity("Today.Web.Models.ProgramInclude", b =>
                {
            ...
            modelBuilder.Entity("Today.Web.Models.ProgramSpecification", b =>
                {
                    b.Property<int>("SpecificationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Today.Web.Models.Screening", b =>
                {
            ...
            modelBuilder.Entity("Today.Web.Models.ShoppingCart", b =>
                {
            ...
            modelBuilder.Entity("Today.Web.Models.Subscription", b =>
                {
            ...
            modelBuilder.Entity("Today.Web.Models.Supplier", b =>
                {
                    b.Property<int>("SupplierId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Today.Web.Models.Tag", b =>
                {
                    b.Property<int>("TagId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Today.Web.Models.Ticket", b =>
                {
                    b.Property<int>("TicketsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Today.Web.Models.staff", b =>
                {
                    b.Property<int>("StaffId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Today.Web.Models.AboutProgramOption", b =>
                {
                    b.HasOne("Today.Web.Models.Product", "Product")
            ...
            modelBuilder.Entity("Today.Web.Models.Category", b =>
                {
                    b.HasOne("Today.Web.Models.Category", "ParentCategory")
            ...
            modelBuilder.Entity("Today.Web.Models.CityRaider", b =>
                {
                    b.HasOne("Today.Web.Models.City", "City")
                        .WithMany("CityRaiders")
                        .HasForeignKey("CityId")
                        .HasConstraintName("FK_CityRaiders_City")
                        .IsRequired();

                    b.HasOne("Today.Web.Models.staff", "Staff")
                        .WithMany("CityRaiders")
            ...
            modelBuilder.Entity("Today.Web.Models.Collect", b =>
                {
                    b.HasOne("Today.Web.Models.Member", "Member")
                        .WithMany("Collects")
            ...
            modelBuilder.Entity("Today.Web.Models.Comment", b =>
                {
                    ...
                    b.HasOne("Today.Web.Models.OrderDetail", "OrderDetails")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("Today.Web.Models.CouponManage", b =>
                {
                    b.HasOne("Today.Web.Models.Coupon", "Coupon")
            ...
            modelBuilder.Entity("Today.Web.Models.Message", b =>
                {
                    ...
                    b.HasOne("Today.Web.Models.Order", "Order")
                        .WithMany("Messages")
                        .HasForeignKey("OrderId")
                        .HasConstraintName("FK_Message_Order")
                        .IsRequired();

                    b.HasOne("Today.Web.Models.Message", "Reply")
            ...
            modelBuilder.Entity("Today.Web.Models.Order", b =>
                {
                    ...
                    b.HasOne("Today.Web.Models.Payment", "Payment")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("Today.Web.Models.OrderDetail", b =>
                {
                    ...
                    b.HasOne("Today.Web.Models.ProgramSpecification", "Specification")
                        .WithMany("OrderDetails")
                        .HasForeignKey("SpecificationId")
                        .HasConstraintName("FK_OrderDetail_ProgramSpecification")
                        .IsRequired();

                    b.HasOne("Today.Web.Models.Ticket", "Tickets")
                        .WithMany("OrderDetails")
            ...
            modelBuilder.Entity("Today.Web.Models.Product", b =>
                {
                    ...
                    b.HasOne("Today.Web.Models.Supplier", "Supplier")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Today.Web.Models.ProductCategory", b =>
                {
                    b.HasOne("Today.Web.Models.Category", "Category")
            ...
            modelBuilder.Entity("Today.Web.Models.ProductTag", b =>
                {
                    ...
                    b.HasOne("Today.Web.Models.Tag", "Tag")
                        .WithMany("ProductTags")
                        .HasForeignKey("TagId")
            ...
            modelBuilder.Entity("Today.Web.Models.ShoppingCart", b =>
                {
                    ...
                    b.HasOne("Today.Web.Models.Screening", "Screening")
                        .WithMany("ShoppingCarts")
